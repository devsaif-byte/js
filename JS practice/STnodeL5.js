...
// const traversing = [sum, sub, times, div, mod];
// const prod1 = 10
// const prod2 = 20
// for (let i = 0; i < traversing.length; i++){
//     const result = traversing[i](prod1, prod2)
//     console.log(`[${traversing[i].name}] Result = ${result}`)
// }


// Array of Array on Dimentional
// const pointTable = [
//     [0, 0],
//     [3, 5],
//     [5, 7],
...
//     return result
// }
// const matrixDone = matrixSum(matrixA, matrixB);
